...
export default function Header({today, date, setDate, setData}: headerProps) {
  ...
  return <div>
    ...
    <Collapsible title="Discover other APOD pictures"><div className="flex">
      <p>Date:</p>
      <input 
    ...
    <Collapsible title="Discover the gallery">
      <div className="input-fields">
        ...
        <p className="subtitle">Pick the start and end date. Start date has to be at least one day before the end date.</p>
        <div className="flex">
          <p>Count:</p>
          <input 
              className="count"
        ...
        <p className="subtitle">Pick a number between 1 and 100. The photos will be random.</p>
      </div>
    </Collapsible>
  </div>
}